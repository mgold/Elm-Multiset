...
never stored explicitly. The library functions enforce this, though it means
that if you map or fold on a multiset, you won't see keys whose count is zero.
